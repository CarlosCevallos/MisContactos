...
public class ContactoFragment extends Fragment {
    ...
    // Metodo que se invoca cuando hay algun cambio en la pantalla
    @Override
    public void onSaveInstanceState(Bundle outState) {
        if (contactoActual != null) {
            ...
            outState.putString("ivContactImage.text", contactoActual.getImageUri());
        }
    }
    ...
    @OnCheckedChanged(R.id.checkboxLV)
